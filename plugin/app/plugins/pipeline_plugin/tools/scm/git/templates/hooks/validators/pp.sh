...
function validate() {
  ...
  if puppet-lint --no-autoloader_layout --no-puppet_url_without_modules --no-80chars --no-top_scope_facts --no-legacy_facts --with-filename "$file_name"|grep "\- WARNING: "; then
