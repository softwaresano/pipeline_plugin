...
Requires:  /usr/sbin/useradd /usr/sbin/usermod rsync curl wget subversion git mercurial rpmdevtools rpm-build createrepo rpm-python ss-develenv-maven ss-develenv-ant ss-develenv-sonar-runner make yum-utils libxslt perl python-demjson
AutoReq:   No
Vendor:    %{vendor}
